          ...
          return MaterialApp(
            ...
            darkTheme: ThemeData(
              ...
              colorScheme: const ColorScheme(
                ...
                // Surface & Background
                surface: Color(0xFF1E1E2C), // Dark blue-grey background
              ...
              appBarTheme: const AppBarTheme(
                centerTitle: true,
                elevation: 0,
                backgroundColor: Color(0xFF1E1E2C),  // Match scaffold/surface
                foregroundColor: Colors.white,
                titleTextStyle: TextStyle(
                  color: Colors.white,
                  fontSize: 20,
              ...
              scaffoldBackgroundColor: const Color(0xFF12121A), // Very dark background
              // Input Theme
              inputDecorationTheme: InputDecorationTheme(
                filled: true,
              ...
              navigationBarTheme: NavigationBarThemeData(
                ...
                indicatorColor: const Color(0xFF818CF8).withAlpha(40),
                labelTextStyle: WidgetStateProperty.resolveWith((states) {
                  if (states.contains(WidgetState.selected)) {
                    return const TextStyle(color: Color(0xFF818CF8));
                  }
